...
public class Product implements Serializable {
    ...
    private List<Waitlist> waitlistedCustomers = new LinkedList<Waitlist>();
    ...
    {
      return waitlistedCustomers.iterator();
    }
    ...
    public boolean addCustomerToWaitlist(Waitlist w){
      return waitlistedCustomers.add(w);
  	}
