...
public class UserState extends WarehouseState{
  ...
  {
      String customerID = WarehouseContext.instance().getUser();
      Customer customer = warehouse.searchCustomer(customerID);
      ...
      double NewClientBalance = warehouse.updateCustomerBalance(customer, Total);
      System.out.println("Client " + customer.getName() + " new balance is " + NewClientBalance);
  ...
  public void AcceptClientPayment()
  {
    ...
    System.out.println("Client " + customer.getName() + " new balance is $" + newTotal);
  }

  public void GetWaitlistedOrdersForClient()
  {
    String clientID = WarehouseContext.instance().getUser();
    Customer c = warehouse.searchCustomer(clientID);
    int i = 1;
